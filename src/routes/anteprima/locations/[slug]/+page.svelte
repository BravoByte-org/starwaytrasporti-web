<!--
	Anteprima Location Page - Italian Preview Mode
	Displays location content in preview mode for Italian users
-->
...
<script>
	...
	let { location, navigation, previewInfo } = data;
	
	onMount(() => {
		console.log('[Anteprima Location IT] Componente montato:', {
		...
		if (typeof document !== 'undefined') {
			document.title = `[ANTEPRIMA] ${location?.name || 'Sede'} - StarwayTrasporti`;
		}
	});
</script>
...
<!-- Page Head -->
<svelte:head>
	<title>[ANTEPRIMA] {location?.name || 'Sede'} - StarwayTrasporti</title>
	<meta name="description" content="Modalità anteprima - {location?.description || 'Anteprima sede'}" />
...
{#if location}
	<div class="location-preview">
				...
				<div class="hero-text">
					...
					<div class="location-details">
						...
						{#if location.operatingHours}
							<div class="detail-item">
								<strong>Orari di Apertura:</strong> {location.operatingHours}
							</div>
						{/if}
		...
		<section class="preview-debug">
			<div class="container">
				<details>
					<summary>Informazioni Debug Anteprima</summary>
...
{:else}
	<div class="location-not-found">
		...
		<p>La sede richiesta non è stata trovata in modalità anteprima.</p>
		<a href="/anteprima">Torna alla Homepage Anteprima</a>
	</div>
{/if}
