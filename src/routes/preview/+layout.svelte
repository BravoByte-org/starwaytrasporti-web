<!--
	Preview Layout Component - English Preview Mode
	Provides preview-specific UI and layout for English preview routes
-->
...
<script>
	...
	onMount(() => {
		...
		console.log('[Preview Layout EN] Initialized:', {
			locale,
			documentId,
			isDraft,
	...
	function exitPreview() {
		if (typeof window !== 'undefined') {
			...
			const currentPath = $page.url.pathname.replace('/preview', '');
	...
	<div class="preview-banner-content">
		<div class="preview-info">
			...
			<span class="preview-text">
				<strong>Preview Mode</strong> - English
				{#if isDraft}
					<span class="draft-indicator">• Draft Content</span>
				{/if}
			</span>
			{#if documentId}
